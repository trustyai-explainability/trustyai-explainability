...
public class InferencePayloadReconciler {
    ...
    private synchronized void save(String id, String modelId) throws InvalidSchemaException, DataframeCreateException {
        ...
        final List<Prediction> prediction = payloadToPrediction(inputBytes, outputBytes);
     ...
     */
    public List<Prediction> payloadToPrediction(byte[] inputs, byte[] outputs) throws DataframeCreateException {
