...
class LimeConfigTest {
    ...
    void testNumericEncodingParams() {
        ...
        AssertionsForClassTypes.assertThat(config.getEncodingParams().getNumericTypeClusterGaussianFilterWidth()).isEqualTo(0.01);
        AssertionsForClassTypes.assertThat(config.getEncodingParams().getNumericTypeClusterThreshold()).isEqualTo(2);
    }
    ...
    void testDataDistribution() {
        ...
        AssertionsForClassTypes.assertThat(config.getDataDistribution()).isEqualTo(dd);
    }
