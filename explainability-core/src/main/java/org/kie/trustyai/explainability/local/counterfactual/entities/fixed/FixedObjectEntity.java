...
/**
 * OptaPlanner representation of a fixed Object feature
 */

public class FixedObjectEntity extends AbstractEntity<Object> {

    public FixedObjectEntity() {
        super();
    }

    private FixedObjectEntity(Object originalValue, String featureName) {
        super(originalValue, featureName, true);
    }

    /**
     * Creates a {@link FixedObjectEntity}, taking the original input value from the
     * provided {@link Feature}.
     *
     * @param originalFeature Original input {@link Feature}
     */
    public static FixedObjectEntity from(Feature originalFeature) {
        return new FixedObjectEntity(originalFeature.getValue().getUnderlyingObject(), originalFeature.getName());
    }
    ...
    /**
     * Returns the {@link FixedObjectEntity} as a {@link Feature}
     *
     * @return {@link Feature}
     */
    @Override
